...
const STATIC_MENU = [
	// Noodles
	{ id: 'mie-aceh', name: { en: 'Mie Aceh',                zh: '亚齐香料面' },
	  aliases: ['mie aceh', 'aceh noodle', 'aceh', '亚齐', '香料面', 'spicy curry noodle'],
	  tags: ['noodles', 'indonesian', 'savory'],                                             price: 115000 },
	{ id: 'mie',      name: { en: 'Mie Goreng',              zh: '印尼炒面' },
	  aliases: ['fried noodle', 'mie goreng', 'mie', 'mee', '炒面', '面条', 'noodle'],
	  tags: ['noodles', 'indonesian', 'savory'],                                             price: 75000 },
	{ id: 'bakmi',    name: { en: 'Bakmi Ayam',              zh: '爪哇鸡肉面' },
	  aliases: ['bakmi', 'chicken noodle', '鸡肉面', '爪哇面', 'bakmi ayam'],
	  tags: ['noodles', 'indonesian', 'savory'],                                             price: 88000 },
	// Rice
	{ id: 'nasi',     name: { en: 'Nasi Goreng',             zh: '印尼炒饭' },
	  aliases: ['fried rice', 'nasi goreng', 'nasi', '炒饭', '炒米饭', 'indonesian rice'],
	  tags: ['rice', 'indonesian', 'savory'],                                                price: 85000 },
	{ id: 'nasi-campur', name: { en: 'Nasi Campur Bali',    zh: '巴厘混合饭' },
	  aliases: ['nasi campur', 'mixed rice', '混合饭', '巴厘饭', 'bali rice'],
	  tags: ['rice', 'indonesian', 'savory'],                                                price: 105000 },
	{ id: 'nasi-uduk',   name: { en: 'Nasi Uduk',           zh: '椰香米饭套餐' },
	  aliases: ['nasi uduk', 'coconut rice', '椰香饭', '椰浆饭'],
	  tags: ['rice', 'indonesian', 'savory'],                                                price: 90000 },
	// Breakfast
	{ id: 'pkx',      name: { en: 'Pancake Stack',           zh: '松饼塔' },
	  aliases: ['pancake', '松饼', '煎饼', '薄饼', 'waffle'],
	  tags: ['sweet', 'western'],                                                            price: 65000 },
	{ id: 'eggs-bene',name: { en: 'Eggs Benedict',           zh: '班尼迪克蛋' },
	  aliases: ['eggs benedict', 'benedict', '班尼迪克', '水波蛋', 'poached egg'],
	  tags: ['western', 'savory'],                                                           price: 95000 },
	{ id: 'bubur',    name: { en: 'Bubur Ayam',              zh: '鸡肉粥' },
	  aliases: ['bubur', 'congee', 'chicken congee', '鸡肉粥', '白粥', 'porridge'],
	  tags: ['rice', 'indonesian', 'savory'],                                                price: 55000 },
	// Lunch
	{ id: 'club',     name: { en: 'Club Sandwich',           zh: '俱乐部三明治' },
	  aliases: ['sandwich', 'club sandwich', 'club', '三明治', '俱乐部'],
	  tags: ['sandwich', 'western'],                                                         price: 95000 },
	{ id: 'gado-gado',name: { en: 'Gado-Gado',              zh: '花生酱蔬菜沙拉' },
	  aliases: ['gado gado', 'gado', 'peanut salad', '花生酱沙拉', '印尼沙拉'],
	  tags: ['healthy', 'vegan', 'indonesian'],                                              price: 75000 },
	{ id: 'satay',    name: { en: 'Chicken Satay',           zh: '鸡肉沙嗲串' },
	  aliases: ['satay', 'sate', '沙嗲', '鸡肉串', 'skewer'],
	  tags: ['indonesian', 'savory'],                                                        price: 85000 },
	// Snacks
	{ id: 'fruit',    name: { en: 'Tropical Fruit Platter',  zh: '热带水果拼盘' },
	  aliases: ['fruit', 'fruit platter', '水果', '拼盘', '热带水果', 'tropical'],
	  tags: ['fruit', 'healthy', 'vegan'],                                                   price: 55000 },
	{ id: 'pisang',   name: { en: 'Pisang Goreng',           zh: '印尼香蕉糕' },
	  aliases: ['pisang goreng', 'banana fritter', '香蕉糕', '炸香蕉', 'pisang'],
	  tags: ['sweet', 'indonesian'],                                                         price: 45000 },
	{ id: 'tempe',    name: { en: 'Tempe Mendoan',           zh: '印尼炸天贝' },
	  aliases: ['tempe', 'tempeh', 'mendoan', '天贝', '炸天贝'],
	  tags: ['indonesian', 'healthy', 'vegan'],                                              price: 40000 },
	// Drinks
	{ id: 'coco',     name: { en: 'Fresh Coconut Water',     zh: '鲜椰青' },
	  aliases: ['coconut', 'coconut water', '椰子', '椰青', '椰子水', '鲜椰'],
	  tags: ['drinks', 'vegan'],                                                             price: 35000 },
	{ id: 'jamu',     name: { en: 'Jamu Herbal Drink',       zh: '传统草本饮' },
	  aliases: ['jamu', 'herbal drink', '草本饮', '传统草本', '姜黄饮', 'turmeric'],
	  tags: ['drinks', 'healthy', 'indonesian'],                                             price: 45000 },
	{ id: 'alpukat',  name: { en: 'Es Alpukat',              zh: '巴厘牛油果奶昔' },
	  aliases: ['alpukat', 'avocado shake', '牛油果', '牛油果奶昔', 'es alpukat'],
	  tags: ['drinks', 'sweet'],                                                             price: 55000 },
];
